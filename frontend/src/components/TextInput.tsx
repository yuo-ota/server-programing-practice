    ...
    <>
      {error === '' ? (
        ...
        <div className={`${className} min-w-24`}>
          <label className="text-subtitle">{label}</label>
          <input
            className="placeholder:text-placeholder text-foreground text-subtitle border-error ease focus:border-error w-full rounded-md border bg-transparent px-3 py-2 shadow-md transition duration-150 focus:shadow focus:outline-none"
            placeholder={placeholder}
          />
